---
title: Databricksでのデータガバナンス：管理タグとUDFでアクセス制御を設計する
tags:
  - 'Databricks'
  - 'Unity Catalog'
  - 'データカバナンス'
private: false
updated_at: '2026-06-17T14:39:43+09:00'
id: addab50ce062855103df
...
- 各項目を入力
  ...
  - 範囲：abacカタログ、すべてのスキーマ
  - 条件：条件なし（スコープ内のすべてのテーブル）
  - 列の条件：これらのタグのいずれかに一致する列で`pii: ssn`を指定
  - マスキング機能：先ほど作った`mask_ssn`を指定
...
![スクリーンショット 2026-06-17 13.08.51.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/4200201/0166a354-76e5-4544-8952-3d926af302a3.png)

![スクリーンショット 2026-06-17 13.21.29.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/4200201/dc91fb47-f36e-4449-9407-aa31ec7cc788.png)



`901-234-5678`を試しにテストすると
`***-**-****`が返され、動きが問題ないことを確認できます。

![スクリーンショット 2026-06-17 13.22.15.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/4200201/3e5639cf-8adb-46b1-aaac-882d98a001ea.png)
...
![スクリーンショット 2026-06-17 13.26.48.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/4200201/83a016bd-5d7c-45ab-8b01-9773e43f5117.png)
...
ポリシー側で「対象列（タグ）」を一律に指定していても、呼び出すUDFの内部で`IS_ACCOUNT_GROUP_MEMBER`や`CURRENT_USER`を使うことで、アクセスしてきたユーザーに応じた動的な制御が可能になります。
...
ここでは、クエリを実行した本人のメールアドレスを取得できる`CURRENT_USER()`関数を活用します。
...
- [チュートリアル: ABAC の構成](https://docs.databricks.com/aws/ja/data-governance/unity-catalog/abac/tutorial)
- [行フィルターと列マスクを手動で適用する](https://docs.databricks.com/aws/ja/data-governance/unity-catalog/filters-and-masks/manually-apply?language=SQL)
- [属性ベースアクセス制御（ABAC）の基本概念](https://docs.databricks.com/aws/ja/data-governance/unity-catalog/abac/core-concepts)
